...
class Results {
  ...
  Results.fromJson(Map<String, dynamic> json)
      : gender = json['gender'],
        name = (json["name"] != null ? Name.fromJson(json['location']) : null)!,
        ...
        picture =
            json['picture'] != null ? Picture2.fromJson(json['picture']) : null,
        nat = json['nat'];
...
class Picture2 {
  ...
  Picture2(this.large, this.medium, this.thumbnail);

  Picture2.fromJson(Map<String, dynamic> json)
      : large = json['large'],
        medium = json['medium'],
